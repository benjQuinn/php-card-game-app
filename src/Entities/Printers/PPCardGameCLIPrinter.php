...
class PPCardGameCLIPrinter implements Printer
{
    ...
    public function printPlayers(string $firstPlayer, string $secondPlayer, string $colour = "default"): PPCardGameCLIPrinter
    {
        echo "\e".$this->colours[$colour].$firstPlayer." and ".$secondPlayer." step up to the table...".$this->closeColourStatement.PHP_EOL;

        return $this;
    }
    public function printPregameWinner(string $winner, string $loser, string $pregame, string $colour = "default"): PPCardGameCLIPrinter
    {
    ...
    public function printStartGame(string $colour = "default"): PPCardGameCLIPrinter
    {
        echo "\e".$this->colours[$colour]."The deck is shuffled...".PHP_EOL.PHP_EOL."Begin!".$this->closeColourStatement.PHP_EOL;

        return $this;
    }
    public function printPlayedCard(int $playerNumber, string $cardFace, string $cardSuit, string $colour = "default"): PPCardGameCLIPrinter
    {
        echo "\e".$this->colours[$colour]."Player ".$playerNumber." card: ".$cardFace." ".$cardSuit.$this->closeColourStatement.PHP_EOL;

        return $this;
    }
    public function printRoundWinner(int $round, $winner, string $colour = "default"): PPCardGameCLIPrinter
    {
        echo "\e".$this->colours[$colour]."Round ".$round." winner: Player ".$winner.$this->closeColourStatement.PHP_EOL.PHP_EOL;

        return $this;
    }
    public function printScore(int $playerNumber, int $score, string $colour = "default"): PPCardGameCLIPrinter
    {
        echo "\e".$this->colours[$colour]."Player " .$playerNumber. " score: " .$score.$this->closeColourStatement.PHP_EOL;

        return $this;
    }
    public function printGameWinner(int $playerNumber, $playerName, $colour = "default"): PPCardGameCLIPrinter
    {
        echo PHP_EOL."\e".$this->colours[$colour]."Player " .$playerNumber. ": " .$playerName. " is the winner!".$this->closeColourStatement.PHP_EOL;

        return $this;
    }
    public function printDraw($colour = "default"): PPCardGameCLIPrinter
    {
    ...
    public function printLineBr(): PPCardGameCLIPrinter
    {
        echo PHP_EOL;

        return $this;
    }
    public function print(string $text, string $colour = "default"): PPCardGameCLIPrinter
    {
